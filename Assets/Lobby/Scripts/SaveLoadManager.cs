...
public static class SaveLoadManager
{
    ...
    public static CharacterStats LoadCharacter(string _characterName)
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            CharacterStats cs = new CharacterStats(data.m_StatsName, data.m_StatsModel, data.m_StatsCurrentHP);
            return cs;
        }
        else
        {
            ...
            CharacterStats cs = new CharacterStats("ERROR", new int[9], 100.0f);
            return cs;
        }
    }
}